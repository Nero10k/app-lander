        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div className="md:col-span-1">
            ...
            <p className="text-white/70 mb-4">
              Your comprehensive solution for overcoming pornography addiction and reclaiming control of your life.
            </p>
            <div className="flex space-x-4">
              ...
              <a href="https://x.com/Pwr_app" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-white transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="#benefits" className="text-white/70 hover:text-white transition-colors">Benefits</Link></li>
              ...
              <li><Link href="#download" className="text-white/70 hover:text-white transition-colors">Download</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/recovery-guide" className="text-white/70 hover:text-white transition-colors">Recovery Guide</Link></li>
        ...
        <div className="border-t border-white/10 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-white/50 text-sm mb-4 md:mb-0">
              &copy; {new Date().getFullYear()} Power App. All rights reserved.
            </p>
            <div className="flex space-x-6">
              ...
              <Link href="/cookie-policy" className="text-white/50 hover:text-white text-sm transition-colors">Cookie Policy</Link>
            </div>
          </div>
        </div>
      </div>
