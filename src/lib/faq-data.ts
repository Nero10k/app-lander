export const faqData = [
  ...
  },
  {
    ...
    questions: [
      {
        q: 'How do I quit porn? Where do I start?',
      ...
      {
        q: 'What should I do after a relapse?',
  ...
  },
  {
    ...
    questions: [
      ...
      {
        q: 'How does the 90-day recovery plan in POWER work?',
        a: 'When you first open POWER, you complete a detailed assessment covering your pornography use history, primary triggers, lifestyle factors, and goals. The app uses this information to generate a personalized week-by-week recovery plan that adapts to your specific situation. The plan includes daily structure recommendations, specific urge management techniques calibrated to your trigger profile, and milestone-based progression. As you log urges and emotional states, the app learns your patterns and can surface relevant support at high-risk times.',
      },
      {
        q: 'Is the POWER app free?',
        a: 'POWER is available as a free download on the App Store with core features accessible without payment. Premium features are available via subscription. We believe the core tools of recovery — streak tracking, urge logging, and the basic recovery framework — should be accessible to anyone who needs them.',
      },
      {
        q: 'Is my data private in the POWER app?',
        a: 'Yes. All data is encrypted in transit and at rest. We do not sell or share personal data with third parties. You can delete your account and all associated data at any time from the app settings. Given the sensitive nature of the subject matter, data privacy is a foundational design principle of POWER, not an afterthought.',
      },
      {
        q: 'Does POWER work on Android?',
        a: "POWER is currently available on iOS (iPhone and iPad). Android support is planned for a future release. If you're on Android, the blog and web tools at powerquitporn.com are fully accessible, and the free recovery assessment at powerquitporn.com/quiz works on any device.",
      },
    ],
  },
];
